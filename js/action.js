...
$(document).ready(function(){
    ...
    var days = Math.floor(t / (1000 * 60 * 60 * 24)).toString().padStart(2, '0');
    var hours = Math.floor((t%(1000 * 60 * 60 * 24))/(1000 * 60 * 60)).toString().padStart(2, '0');
    var minutes = Math.floor((t % (1000 * 60 * 60)) / (1000 * 60)).toString().padStart(2, '0');
    var seconds = Math.floor((t % (1000 * 60)) / 1000).toString().padStart(2, '0');
    ...
    function progress(timeleft, timetotal, $element) {
        ...
        $element.find('div').animate({ width: progressBarWidth }, timeleft == timetotal ? 1000 : 0, 'linear');
        if(timeleft > 0) {
            setTimeout(function() {
...
//   let i = 0
//   while (i < carouselScrollWidth) {
//     setTimeout(carouselContainer.scrollTo(i, 0), 10000)
//     console.log(i)
//     i++;
//   }
// })
  ...
  // Scroll to top button - Get the button:
